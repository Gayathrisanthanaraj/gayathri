...
<nav>
<ul>
<li class="logo"><img src="../Saved Pictures/image4.jpg"></li>
<li>
...
<div class="wrapper">
<div class="section">
<h2 id="head" style="color: #2b2626">Your Profile</h2>
<div class="card">
<div class="container">
<p>
<table>
<tr colspan="3"><img id="img">
</tr>
<tr>
...
<tr>
<th><label>Date Of Birth</th><th>:</th></label><td><span id="demo6"></span></td>
</tr>
<tr>
<th><label>City</th><th>:</th></label><td><span id="demo7"></span></td>
</tr>
<tr>
<th>&nbsp;</th>
</tr>
...
document.getElementById("demo").innerHTML =data.fname+"   "+data.lname;
document.getElementById("demo2").innerHTML = data.age;
document.getElementById("demo3").innerHTML = data.contact;
document.getElementById("demo4").innerHTML = data.email;
document.getElementById("demo5").innerHTML = data.pass;
document.getElementById("demo6").innerHTML = data.date;
document.getElementById("demo7").innerHTML = data.city;
